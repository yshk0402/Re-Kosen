 ...
 */ var isDevelopmentMode = (async (ctx, next)=>{
    ...
    if (autoReload !== true) {
        ...
        throw new utils.errors.PolicyError('Content-Type Builder modifications are disabled in production mode. Schema changes can only be made when running with autoReload enabled (strapi develop).');
    }
    await next();
});

module.exports = isDevelopmentMode;
//# sourceMappingURL=is-development-mode.js.map
