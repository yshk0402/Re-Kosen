...
### 5.10 References（参考資料）
- 目的: 記事の信頼性を担保するための出典リスト
- 位置: **記事末尾に固定表示**（本文中には挿入しない）
- 入力:
  - title（任意）: 既定は「参考資料」
  - items（必須）: 1件以上
    - title（必須）: 出典名（例: 「経済産業省 令和X年版○○白書」）
    - url（必須）: 出典URL（`https://` から）
    - note（任意）: 版・年度・補足（例: 「2024年版」「最終閲覧: 2026-02-03」）
- 推奨ソース: 企業公式、官公庁、業界団体、大手メディア、信頼性の高い統計
- 避けるソース: 個人ブログ、出所不明、引用元が不明なまとめサイト
